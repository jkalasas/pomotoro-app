        ...
        <div className="flex items-center gap-4">
          ...
          >
            <DialogTrigger asChild>
              <Button className="inline-flex items-center gap-2 bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary/80 text-primary-foreground shadow-lg hover:shadow-xl hover:shadow-primary/20 transition-all duration-300 rounded-full px-6 py-2 text-sm font-medium">
            ...
            <DialogContent className="sm:max-w-[400px] rounded-xl">
              ...
              <div className="space-y-3 mt-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <Label htmlFor="newFocus" className="text-sm">
                      Focus Duration (min)
                    </Label>
                    <Input
                      id="newFocus"
                  ...
                  <div>
                    <Label htmlFor="newShort" className="text-sm">
                      Short Break (min)
                    </Label>
                    <Input
                      id="newShort"
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <Label htmlFor="newLong" className="text-sm">
                      Long Break (min)
                    </Label>
                    <Input
                      id="newLong"
                  ...
                  <div>
                    <Label htmlFor="newCycles" className="text-sm">
