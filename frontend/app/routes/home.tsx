  ...
  return (
    <main className="flex flex-col pb-8 gap-8 p-8 min-h-screen">
      ...
      <div className="flex flex-col xl:flex-row gap-4 w-full items-stretch h-full">
        <Card
          className="flex-1 max-h-fit backdrop-blur-md bg-gradient-to-br from-card/90 to-card/70 border-border/40 shadow-lg shadow-primary/5 hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 rounded-xl overflow-hidden"
          ...
          <CardContent className="px-6 py-2">
            <div className="flex flex-col items-center mb-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-bold text-lg text-center bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text text-transparent">
                  Current Task
                </span>
              </div>
        ...
        <Card
          className="flex-2 backdrop-blur-md bg-gradient-to-br from-card/90 to-card/70 border-border/40 shadow-lg shadow-primary/5 hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 rounded-xl overflow-hidden"
          style={{
            ...
            <div className="flex flex-col gap-3">
              {visibleSchedule.length > 0 ? (
                visibleSchedule.slice(0, 5).map((task: any, index: number) => (
                  <div
                    key={task.id}
                    className="flex items-center gap-3 p-3 rounded-lg bg-gradient-to-r from-muted/20 to-muted/10 hover:from-muted/30 hover:to-muted/20 transition-all duration-300 group border border-border/20 hover:border-border/40 hover:shadow-md"
                  >
                    <Checkbox
                    ...
                    />
                    <span
                      className={`flex-1 transition-all duration-200 font-medium text-sm ${
                        task.completed
